...
**As of macOS 10.14 Mojave, I have not had time to maintain this project, so it may not work well on recent versions of macOS. Pull requests to help with the maintenance welcome!**
